# Instructions for building and running Staggered Multigrid on the Crusher supercomputer
...
| ` mkdir QUDA install` and ` mkdir QUDA/src` | Manually create some empty directories inside `build_dir`  |
