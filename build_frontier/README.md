...
- **Using the python script**  :
  - Run the script [build_frontier/build_install_scripts.py](https://github.com/vmos1/Staggered_multigrid_build/blob/main/build_frontier/build_install_scripts.py) as `python build_install_scripts.py --machine frontier -bdir <build_dir>`. 
